...
!(function (e, t) {
    ...
    return function (o, e) {
        ...
        w.cancelScroll = function (e) {
            ...
            w.cancelScroll();
            var c = H(M || L, e || {}), u = "[object Number]" === Object.prototype.toString.call(i),
                t = u || !i.tagName ? null : i;
            if (u || t) {
                var l = C.pageYOffset;
                c.header && !I && (I = document.querySelector(c.header));
                var n, o, a, d, r, f, m, h, p = x(I), g = u ? i : (function (e, t, n, o) {
                        var a = 0;
        ...
        var t = function (e) {
            ...
            if (null !== history.state && history.state.smoothScroll && history.state.smoothScroll === JSON.stringify(M)) {
                ...
                "string" == typeof t && t && !(t = document.querySelector(r(history.state.anchor))) || w.animateScroll(t, null, {updateURL: !1})
            }
        };
        w.destroy = function () {
