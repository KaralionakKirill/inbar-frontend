!function (e, t) {
    ...
    function o(e) {
        ...
        var r = t(e), i = r.overflow, s = r.overflowX, f = r.overflowY;
    ...
    function f(e, t) {
        ...
        var p, l, u = a.commonAncestorContainer;
    ...
    function c(e) {
        ...
        try {
            if (r(10)) {
                ...
                var o = a(e, "top"), i = a(e, "left");
                n.top += o, n.left += i, n.bottom += o, n.right += i
            } else n = e.getBoundingClientRect()
        } catch (e) {
        }
        var s = {left: n.left, top: n.top, width: n.right - n.left, height: n.bottom - n.top},
            f = "HTML" === e.nodeName ? u() : {}, l = f.width || e.clientWidth || s.right - s.left,
            c = f.height || e.clientHeight || s.bottom - s.top, h = e.offsetWidth - l, m = e.offsetHeight - c;
        if (h || m) {
            var g = t(e);
    ...
    function h(e, n) {
        var i = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], s = r(10), f = "HTML" === n.nodeName,
            p = c(e), l = c(n), u = o(e), h = t(n), m = parseFloat(h.borderTopWidth, 10),
        ...
        if (v.marginTop = 0, v.marginLeft = 0, !s && f) {
            var b = parseFloat(h.marginTop, 10), w = parseFloat(h.marginLeft, 10);
        ...
        return (s && !i ? n.contains(u) : n === u && "BODY" !== u.nodeName) && (v = function (e, t) {
            var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], o = a(t, "top"), r = a(t, "left"),
                i = n ? -1 : 1;
    ...
    function g(e, r, i, s) {
        var p = 4 < arguments.length && void 0 !== arguments[4] && arguments[4], l = {top: 0, left: 0},
            c = p ? m(e) : f(e, r);
        if ("viewport" === s) l = function (e) {
            var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
                n = e.ownerDocument.documentElement, o = h(e, n), r = W(n.clientWidth, window.innerWidth || 0),
                i = W(n.clientHeight, window.innerHeight || 0), s = t ? 0 : a(n), f = t ? 0 : a(n, "left");
    ...
    function E(e, t, n) {
        n = n.split("-")[0];
        var o = w(e), r = {width: o.width, height: o.height}, i = -1 !== ["right", "left"].indexOf(n),
    ...
    function N(e, t, n, r) {
        ...
        return function e(t, n, r, i) {
            var s = "BODY" === t.nodeName, f = s ? t.ownerDocument.defaultView : t;
    ...
    function A(e, t, n, o) {
        var r = [0, 0], i = -1 !== ["right", "left"].indexOf(o), s = e.split(/(\+|\-)/).map(function (e) {
            return e.trim()
        ...
        return (p = p.map(function (e, o) {
            var r = (1 === o ? !i : i) ? "height" : "width", s = !1;
            return e.reduce(function (e, t) {
                return "" === e[e.length - 1] && -1 !== ["+", "-"].indexOf(t) ? (e[e.length - 1] = t, s = !0, e) : s ? (e[e.length - 1] += t, s = !1, e) : e.concat(t)
            }, []).map(function (e) {
                return function (e, t, n, o) {
                    var r = e.match(/((?:\-|\+)?\d*\.?\d*)(.*)/), i = +r[1], s = r[2];
                    if (!i) return e;
                    if (0 === s.indexOf("%")) {
                        var f;
                        switch (s) {
    ...
    for (var B = Math.min, M = Math.round, P = Math.floor, W = Math.max, j = "undefined" != typeof window && "undefined" != typeof document, R = ["Edge", "Trident", "Firefox"], I = 0, U = 0; U < R.length; U += 1) if (j && 0 <= navigator.userAgent.indexOf(R[U])) {
        I = 1;
        break
    }
    var Y = j && window.Promise ? function (e) {
        ...
        }, q = j && !(!window.MSInputMethodContext || !document.documentMode), z = j && /MSIE 10/.test(navigator.userAgent),
        G = function (e, t) {
        ...
        K = J.slice(3), Q = "flip", Z = "clockwise", $ = "counterclockwise", ee = function () {
            function t(n, o) {
                var r = this, i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {};
        ...
        placement: "bottom", positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: function () {
            ...
            shift: {
                order: 100, enabled: !0, fn: function (e) {
                    ...
                    if (o) {
                        var r = e.offsets, i = r.reference, s = r.popper, f = -1 !== ["bottom", "top"].indexOf(n),
                ...
                order: 200, enabled: !0, fn: function (e, t) {
                    var n, o = t.offset, r = e.placement, i = e.offsets, s = i.popper, f = i.reference,
                        a = r.split("-")[0];
                ...
                order: 300, enabled: !0, fn: function (e, t) {
                    ...
                    var o = T("transform"), r = e.instance.popper.style, s = r.top, f = r.left, a = r[o];
                    r.top = "", r.left = "", r[o] = "";
                ...
                order: 400, enabled: !0, fn: function (e) {
                    var t = e.offsets, n = t.popper, o = t.reference, r = e.placement.split("-")[0], i = P,
                ...
                order: 500, enabled: !0, fn: function (e, n) {
                    ...
                    var i = e.placement.split("-")[0], s = e.offsets, f = s.popper, a = s.reference,
                        p = -1 !== ["left", "right"].indexOf(i), l = p ? "height" : "width", u = p ? "Top" : "Left",
                        c = u.toLowerCase(), h = p ? "left" : "top", m = p ? "bottom" : "right", g = w(r)[l];
                    a[m] - g < f[c] && (e.offsets.popper[c] -= f[c] - (a[m] - g)), a[c] + g > f[m] && (e.offsets.popper[c] += a[c] + g - f[m]), e.offsets.popper = d(e.offsets.popper);
                    var v = a[c] + a[l] / 2 - g / 2, b = t(e.instance.popper), y = parseFloat(b["margin" + u], 10),
                        E = parseFloat(b["border" + u + "Width"], 10), x = v - e.offsets.popper[c] - y - E;
                ...
                order: 600, enabled: !0, fn: function (e, t) {
                    ...
                    var n = g(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement, e.positionFixed),
                        o = e.placement.split("-")[0], r = y(o), i = e.placement.split("-")[1] || "", s = [];
                    switch (t.behavior) {
                        case Q:
                            s = [o, r];
                            break;
                    ...
                    return s.forEach(function (f, a) {
                        ...
                        var p, l = e.offsets.popper, u = e.offsets.reference, d = P,
                            c = "left" === o && d(l.right) > d(u.left) || "right" === o && d(l.left) < d(u.right) || "top" === o && d(l.bottom) > d(u.top) || "bottom" === o && d(l.top) < d(u.bottom),
                            h = d(l.left) < d(n.left), m = d(l.right) > d(n.right), g = d(l.top) < d(n.top),
                ...
                order: 850, enabled: !0, fn: function (e, t) {
                    var n = t.x, o = t.y, r = e.offsets.popper, s = x(e.instance.modifiers, function (e) {
                        return "applyStyle" === e.name
                    }).gpuAcceleration;
                    void 0 !== s && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                    var f, a, p = void 0 === s ? t.gpuAcceleration : s, l = c(i(e.instance.popper)),
                        u = {position: r.position},
                        d = {left: P(r.left), top: M(r.top), bottom: M(r.bottom), right: P(r.right)},
                        h = "bottom" === n ? "top" : "bottom", m = "right" === o ? "left" : "right", g = T("transform");
                    if (a = "bottom" == h ? -l.height + d.bottom : d.top, f = "right" == m ? -l.width + d.right : d.left, p && g) u[g] = "translate3d(" + f + "px, " + a + "px, 0)", u[h] = 0, u[m] = 0, u.willChange = "transform"; else {
                        var v = "bottom" == h ? -1 : 1, b = "right" == m ? -1 : 1;
